...
void Deplome::on_btnValider_clicked()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, "Enregistrer le certificat", "certificat.pdf", "PDF (*.pdf)");
    if (filename.isEmpty()) return;
    if (!filename.endsWith(".pdf")) filename += ".pdf";

    // Génération unique du PDF
    ...
    // Calcul du hash après génération
    ...
    // Enregistrement du hash dans fichier texte
