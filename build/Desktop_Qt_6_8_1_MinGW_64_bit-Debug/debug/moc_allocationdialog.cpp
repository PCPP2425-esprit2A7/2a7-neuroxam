...
namespace {
struct qt_meta_tag_ZN16allocationdialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16allocationdialogE = QtMocHelpers::stringData(
    "allocationdialog",
    "allocationConfirmed",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16allocationdialogE[] = {
...
Q_CONSTINIT const QMetaObject allocationdialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16allocationdialogE.offsetsAndSizes,
    qt_meta_data_ZN16allocationdialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16allocationdialogE_t,
        // Q_OBJECT / Q_GADGET
...
void allocationdialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (allocationdialog::*)();
            if (_q_method_type _q_method = &allocationdialog::allocationConfirmed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *allocationdialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16allocationdialogE.stringdata0))
