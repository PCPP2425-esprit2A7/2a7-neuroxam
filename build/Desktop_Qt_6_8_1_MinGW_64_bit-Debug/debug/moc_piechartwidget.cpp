...
static constexpr auto qt_meta_stringdata_ZN14PieChartWidgetE = QtMocHelpers::stringData(
    "PieChartWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14PieChartWidgetE[] = {
...
Q_CONSTINIT const QMetaObject PieChartWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14PieChartWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14PieChartWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14PieChartWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *PieChartWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14PieChartWidgetE.stringdata0))
