...
namespace {
struct qt_meta_tag_ZN8TodoListE_t {};
} // unnamed namespace
...
Q_CONSTINIT static const uint qt_meta_data_ZN8TodoListE[] = {
...
Q_CONSTINIT const QMetaObject TodoList::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8TodoListE.offsetsAndSizes,
...
void *TodoList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8TodoListE.stringdata0))
