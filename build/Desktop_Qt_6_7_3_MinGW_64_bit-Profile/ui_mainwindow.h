...
"color:white;\n"
"background-image: url(:/resources/background.png);"));
        lineEditCentre = new QLineEdit(widget_5);
        lineEditCentre->setObjectName("lineEditCentre");
        lineEditCentre->setGeometry(QRect(210, 110, 141, 31));
...
"background-image: url(:/res/resources/background.png);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEditCentre->setPlaceholderText(QCoreApplication::translate("MainWindow", "Ex : Centre Formation X", nullptr));
