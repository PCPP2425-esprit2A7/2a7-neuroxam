...
"background-image: url(:/res/resources/background.png);"));
        ...
        widget_2->setGeometry(QRect(310, 15, 631, 321));
        ajoute_2 = new QPushButton(widget_2);
...
"color:white;\n"
"background-image: url(:/res/resources/background.png);"));
        facilities_2 = new QLineEdit(widget_2);
...
"color: rgb(0, 0, 0);\n"
""));
        directeur_2 = new QLineEdit(widget_2);
...
"border:none;"));
        capacite_2 = new QLineEdit(widget_2);
...
"border:none;"));
        adresse_2 = new QLineEdit(widget_2);
...
"\n"
""));
        status_2 = new QComboBox(widget_2);
...
"color: rgb(0, 0, 0);"));
        modifier_2 = new QPushButton(widget_2);
...
"color:white;\n"
"background-image: url(:/res/resources/background.png);"));
        nomeror_2 = new QLineEdit(widget_2);
...
"color: rgb(255, 12, 12);"));
        ...
        adseror_2 = new QLineEdit(widget_2);
...
"color: rgb(255, 12, 12);"));
        ...
        drteror_2 = new QLineEdit(widget_2);
...
"color: rgb(255, 12, 12);"));
        ...
        cpteror_2 = new QLineEdit(widget_2);
