...
bool employe::create() {
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO employe (nom, prenom, numero_telephone, email, password, date_dembauche) "
                  "VALUES (:nom, :prenom, :numero_telephone, :email, :password, TO_DATE(:date_dembauche, 'YYYY-MM-DD'))");
