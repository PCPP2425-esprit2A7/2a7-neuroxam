...
void ChatbotIA::envoyerPromptIA(const QString &texte)
{
    ...
    // Clé API écrite en dur (⚠️ à éviter en production)
    request.setRawHeader("Authorization", "Bearer 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");
