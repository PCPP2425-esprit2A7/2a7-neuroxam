...
void ChatbotIA::envoyerPromptIA(const QString &texte)
{
    ...
    request.setRawHeader("Authorization", "Bearer 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"); // ⚠️ à remplacer par une clé personnelle si besoin
