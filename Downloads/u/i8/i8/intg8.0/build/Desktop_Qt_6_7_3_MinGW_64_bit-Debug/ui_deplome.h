...
"   "));
        ...
        lineEditNomEmploye = new QLineEdit(Deplome);
        lineEditNomEmploye->setObjectName("lineEditNomEmploye");

        verticalLayout->addWidget(lineEditNomEmploye);
